...
class ReportUpdatedEvent extends event_js_1.Event {
    constructor(response) {
        super(response);
        this.eventType = index_js_1.EventName.ReportUpdated;
        this.data = new index_js_2.ReportNotification(response.data);
    }
}
