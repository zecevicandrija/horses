...
class DiscountImportedEvent extends event_js_1.Event {
    constructor(response) {
        super(response);
        this.eventType = index_js_1.EventName.DiscountImported;
        this.data = new index_js_2.DiscountNotification(response.data);
    }
}
